...
/**
 * Created by songxianying on 17/7/19.
 */
public class MailSendUtil {
    private final static String host = "smtp.163.com"; //163的服务器
    private final static String formName = "tj_mail_service@163.com";//你的邮箱
    private final static String password = "tjmailservice1"; //授权码
    private final static String replayAddress = "tj_mail_service@163.com"; //你的邮箱
    ...
    private static Message getMessage(MailInfo info) throws Exception{
        ...
        //消息的发送者
        message.setFrom(new InternetAddress(p.getProperty("mail.smtp.user"),"铁建风险报告"));
        // 创建邮件的接收者地址，并设置到邮件消息中
        message.setRecipients(Message.RecipientType.TO,InternetAddress.parse(info.getToAddress()));
        // 消息发送的时间
